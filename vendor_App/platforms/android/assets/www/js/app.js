...
// };
  ...
  //  _waitForAnalytics();
     ...
     var statesLink = "http://vergeapp.com/vendorapp_api/api/states";
    ...
    $scope.data = {};
    var link1 = "http://vergeapp.com/vendorapp_api/api/signup";
      ...
      $scope.doRegister = function(){
       ...
       $scope.edit = {}
       var editLink = "http://vergeapp.com/vendorapp_api/api/editProfile";
      ...
      $scope.loginData = {};
      var dashboard = "http://vergeapp.com/vendorapp_api/api/dashboard"
      var url = "http://vergeapp.com/vendorapp_api/api/vendors";
      var link = "http://vergeapp.com/vendorapp_api/api/signin";
      var profileLink = "http://vergeapp.com/vendorapp_api/api/profile";
         ...
         if(window.Connection){
           if(navigator.connection.type == Connection.NONE){
            ...
            $http.post(link, $scope.loginData).success(function(response){
              window.localStorage.setItem("username", $scope.loginData.phone);
     ...
     var getOrderlink = "http://vergeapp.com/vendorapp_api/api/getorders"; 
    ...
    $scope.vendor = {};
    var link2 = "http://vergeapp.com/vendorapp_api/api/add_vendor";
    ...
    $scope.selectVendor = function(){
       ...
       if(window.Connection){
          if(navigator.connection.type == Connection.NONE){
            ...
            $http.get("http://vergeapp.com/vendorapp_api/api/price_list", {params:{"vendor_id": $rootScope.myVendorid, "phone": $rootScope.phone}})
    ...
    var placeOrderLink = "http://vergeapp.com/vendorapp_api/api/placeorder";
    ...
    $scope.back = function(){
      ...
      var orderedItemsLink = "http://vergeapp.com/vendorapp_api/api/items_ordered";
